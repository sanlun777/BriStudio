                    ...
                    if(idUsuario == null){
                        ...
                        if(permisosUsuario.exists(Permisos.permiso.CREAUSUARIO)){
                            out.println("<main class='contenido'>");
                                ...
                                out.println("<center><p class='tituloPanel'>Registro</p></center>");
                                    ...
                                    out.println("<section class='formulario-registro'>");
                                        ...
                                        out.println("<form action = '/BristudioAnt/Registro' method = 'post' enctype='multipart/form-data'>");
                                            ...
                                            out.println("<label for='imgUsu'>Sube foto (Opcional)</label>)");
                                            out.println("<input class='campos' type='file' name='imgUsu' id='imgUsu'>");
                                            ...
                                            if(permisosUsuario.exists(Permisos.permiso.PERMITECREAUSUARIO)){
                                                out.println("<label><input type='checkbox' name='crea_usuario' id='crea_usuario' value='1'>Permitir creación de usuarios</label>");
                                            }
                                            if(permisosUsuario.exists(Permisos.permiso.AUDITORIA)){
                                                out.println("<label><input type='checkbox' name='crea_cursos' id='crea_cursos' value='1'>Permitir creación de cursos</label>");
                                                out.println("<label><input type='checkbox' name='permite_crea_usuario' id='permite_crea_usuario' value='1'>Permitir usuarios que puedan crear usuarios</label>");
                                                out.println("<label><input type='checkbox' name='auditoria' id='auditoria' value='1'>Permitir auditoría</label>");
                                            }
